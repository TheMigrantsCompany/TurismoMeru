  ...
  return (
    <nav className="bg-white shadow dark:bg-gray-800 sticky top-0 z-50 opacity-70">
      <div className="container flex items-center justify-center p-1 mx-auto text-gray-900 capitalize dark:text-gray-300">
        ...
        <a href="#" className="border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m.75 19h7.092c4.552 0 6.131-6.037 2.107-8.203 2.701-2.354 1.029-6.797-2.595-6.797h-6.604c-.414 0-.75.336-.75.75v13.5c0 .414.336.75.75.75zm8.657-2c0 1.732 2.447 4 5.5 4s5.5-2.268 5.5-4-2.447-4-5.5-4-5.5 2.268-5.5 4zm3.25 0c0-.828 1.343-2 3-2s3 1.172 3 2-1.343 2-3 2-3-1.172-3-2zm0-5.75h5.5c.414 0 .75-.336.75-.75v-2.5h-6.25c-.414 0-.75.336-.75.75v2.5c0 .414.336.75.75.75zm12.75-6h-4.5v-8h4.5c.414 0 .75.336.75.75v6.5c0 .414-.336.75-.75.75zm0-8h-4.5c-.414 0-.75.336-.75.75v2.5h5.5v-2.5c0-.414-.336-.75-.75-.75z"/></svg>
        </a>

        <div className="relative inline-block text-left">
          <div>
            <button type="button" className="flex items-center text-gray-600 dark:text-gray-300 focus:outline-none">
              <svg className="w-2 h-1 fill-current" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 15.36l4.52 2.236-.865-5.044 3.664-3.682-5.047-.733L12 2l-1.748 5.184-5.048.733 3.664 3.682-.865 5.044L12 15.36z"/></svg>
